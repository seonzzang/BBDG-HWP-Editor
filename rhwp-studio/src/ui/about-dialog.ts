...
export class AboutDialog extends ModalDialog {
  ...
  protected createBody(): HTMLElement {
    ...
    titleText.style.fontSize = '1.3rem';
    titleText.style.fontWeight = '800';
    titleText.style.color = '#0f172a';
    titleText.style.marginBottom = '4px';
    titleText.textContent = productData.productName;
    body.appendChild(titleText);

    const versionDisplay = document.createElement('div');
    versionDisplay.style.fontSize = '0.75rem';
    versionDisplay.style.color = '#94a3b8';
    versionDisplay.style.marginBottom = '24px';
    versionDisplay.style.letterSpacing = '0.05em';
    versionDisplay.textContent = `VERSION ${productData.version}`;
    body.appendChild(versionDisplay);
    ...
    scrollBox.innerHTML = `
      ...
      <div style="margin-left: 4px; margin-bottom: 24px;">
        ...
        <div style="margin-bottom: 4px;">
          ...
          <a href="#" id="bbdg-home" style="color: #4c6ef5; text-decoration: underline; font-weight: 600;">${productData.manufacturer.nameKr}</a>
    ...
    setupLink('bbdg-home', productData.manufacturer.url);
    ...
    footerCopyright.textContent = "BBDG HWP EDITOR IS AN INDEPENDENT SOFTWARE PROJECT.";
