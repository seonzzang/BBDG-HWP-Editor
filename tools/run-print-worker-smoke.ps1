...
$tempDir = Join-Path $env:TEMP 'bbdg-print-worker-smoke'
...
if (-not $env:BBDG_PUPPETEER_EXECUTABLE_PATH) {
  $env:BBDG_PUPPETEER_EXECUTABLE_PATH = 'C:\Program Files\Google\Chrome\Application\chrome.exe'
}
