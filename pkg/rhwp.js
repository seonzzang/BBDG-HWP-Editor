...
export class HwpDocument {
     ...
     */
    isPagingFinished() {
        const ret = wasm.hwpdocument_isPagingFinished(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * 논리적 오프셋 → 텍스트 오프셋 변환.
     ...
     * 증분 페이징을 시작한다.
     */
    startProgressivePaging() {
        const ret = wasm.hwpdocument_startProgressivePaging(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @returns {number}
     */
    stepProgressivePaging(chunk_size) {
        const ret = wasm.hwpdocument_stepProgressivePaging(this.__wbg_ptr, chunk_size);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_measureTextWidth_f5a3452ebb0bf19f: function(arg0, arg1, arg2, arg3) {
